...
void process_json(const std::string& json_str, std::shared_ptr<ClientConnection> client, std::map<std::string, std::shared_ptr<Process>>& active_processes) {
    ...
    if (command == "INIT" || command == "INIT_2D" || command == "INIT_3D" || command == "INIT_MPM" || command == "INIT_2D_MPM" || command == "INIT_3D_MPM" || command == "INIT_MPM_3D" || command == "INIT_FSI_2D" || command == "INIT_FSI_3D" || command == "INIT_FSI") {
    ...
    if (command == "INIT" || command == "START" || command == "INIT_2D" || command == "INIT_3D" || command == "INIT_MPM" || command == "INIT_2D_MPM" || command == "INIT_3D_MPM" || command == "INIT_MPM_3D" || command == "INIT_FSI_2D" || command == "INIT_FSI_3D" || command == "INIT_FSI") {
        ...
        if (command == "PAUSE" || command == "PAUSE_2D" || command == "PAUSE_3D" || command == "PAUSE_MPM" || command == "PAUSE_3D_MPM" || command == "PAUSE_MPM_3D" || command == "PAUSE_FSI_2D" || command == "PAUSE_FSI_3D" || command == "PAUSE_FSI") std::cout << "[DEBUG] PAUSE COMMAND RECEIVED for modelId " << modelId << "\n";
        if (command == "TERMINATE" || command == "TERMINATE_2D" || command == "TERMINATE_3D" || command == "TERMINATE_MPM" || command == "TERMINATE_3D_MPM" || command == "TERMINATE_MPM_3D" || command == "TERMINATE_FSI_2D" || command == "TERMINATE_FSI_3D" || command == "TERMINATE_FSI") std::cout << "[DEBUG] TERMINATE COMMAND RECEIVED for modelId " << modelId << "\n";
