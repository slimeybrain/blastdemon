...
int main(int argc, char** argv) {
    ...
    std::cout << "======================================================================" << std::endl;
    std::cout << "=== REGULAR STRUCTURED RC HOLLOW BOX GENERATOR (20MM ELEMENTS) =======" << std::endl;
    std::cout << "======================================================================" << std::endl;
    ...
    std::cout << "Grid Resolution: Nx=" << Nx << ", Ny=" << Ny << ", Nz=" << Nz << " (Total Cells: " << Nx * Ny * Nz << ")" << std::endl;
    ...
    for (const auto& cell : solid_cells) {
        // Standard LS-DYNA Hex8 node numbering:
        // Bottom face: (i, j, k), (i+1, j, k), (i+1, j+1, k), (i, j+1, k)
        // Top face:    (i, j, k+1), (i+1, j, k+1), (i+1, j+1, k+1), (i, j+1, k+1)
    ...
    out << "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n";
    out << "$ LS-DYNA KEYWORD DECK: REGULAR STRUCTURED RC HOLLOW BOX (2M, 20MM ELEMENTS)\n";
    ...
    out << "*KEYWORD\n";
    out << "*TITLE\n";
    out << "Regular Structured RC Hollow Box 2m (20mm Hexes, 125mm Rebar)\n";
    ...
    // Export VTK files
    {
        std::ofstream vtk("regular_concrete_20mm.vtk");
        vtk << "# vtk DataFile Version 3.0\nRegular Concrete 20mm\nASCII\nDATASET UNSTRUCTURED_GRID\n";
    ...
    {
        std::ofstream vtk("regular_rebar_20mm.vtk");
        vtk << "# vtk DataFile Version 3.0\nRegular Rebar 20mm\nASCII\nDATASET UNSTRUCTURED_GRID\n";
        vtk << "POINTS " << nodes.size() << " float\n";
        for (const auto& p : nodes) vtk << float(p.x) << " " << float(p.y) << " " << float(p.z) << "\n";
